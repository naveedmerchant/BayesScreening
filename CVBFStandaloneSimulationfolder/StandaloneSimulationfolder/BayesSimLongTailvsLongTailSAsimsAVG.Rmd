...
plot1 = ggplot(dfCVBF, aes(x = p, y = logBF)) + geom_point()  + geom_hline(yintercept = 0, color = "blue", se = FALSE) + geom_smooth(colour = "red", se = FALSE) + ylim(c(-70, 50))
plot1
ggsave("BayesSimPlots/CVBFLongvLong.pdf",plot = plot1, device = "pdf")
...
plot1 = ggplot(dfKS, aes(x = p, y = logks)) + geom_point()  + geom_hline(yintercept = log(.05), color = "blue") + geom_smooth(se = FALSE)
plot1
ggsave("BayesSimPlots/KSLongvLong.pdf",plot = plot1, device = "pdf")
...
plot1 = ggplot(dfPT, aes(x = p, y = logBF)) + geom_point()  + geom_hline(yintercept = 0, color = "blue") + geom_smooth(colour = "red", se = FALSE) + ylim(c(-70, 50))
plot1
ggsave("BayesSimPlots/PTNLongvLong.pdf",plot = plot1, device = "pdf")
...
plot1 = ggplot(dfPT2, aes(x = p, y = logBF)) + geom_point()  + geom_hline(yintercept = 0, color = "blue") + geom_smooth(colour = "red", se = FALSE) + ylim(c(-70, 50))
plot1
ggsave("BayesSimPlots/PTCLongvLong2.pdf",plot = plot1, device = "pdf",  width = 7, height = 5)
...
write.csv(dfall, file = "logBFsandKSvaluesforlongvlong")
...
dfall = read.csv("logBFsandKSvaluesforlongvlong.csv")
...
#  geom_point() +
  ...
  geom_smooth(aes(p, logKSb, color = "Adjusted KS p-value"), linetype = 4, se = FALSE) +
  labs(x = "p", y = "log(BF)", color = "Legend") + ylim(c(-70, 50)) + scale_color_manual(values=colors)

plot1

ggsave("BayesSimPlots/jointlogBFLongvLongLegend.pdf",plot = plot1, device = "pdf")
