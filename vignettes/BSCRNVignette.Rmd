...
The numbers for PT and CVBF are different, because we only ran this on 20 predictors. Parallelization allows a huge speed up for these two tests, so much so that we opted against running it for 500 because it takes a long time.
